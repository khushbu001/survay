...
*/
@Component
public class ResponseDataMapperImpl implements ResponseDataMapper {

    @Override
    public ResponseDataDTO toResponseDataDTO(ResponseData response) {
        if ( response == null ) {
            return null;
        }
        ...
        responseDataDTO.setResponseDataID( response.getResponseDataID() );
        responseDataDTO.setData( response.getData() );
        responseDataDTO.setResponse( responseToResponseDTO( response.getResponse() ) );

        return responseDataDTO;
    }

    @Override
    public List<ResponseDataDTO> toResponseDataDTOs(List<ResponseData> response) {
        if ( response == null ) {
            return null;
        }

        List<ResponseDataDTO> list = new ArrayList<ResponseDataDTO>( response.size() );
        for ( ResponseData responseData : response ) {
            list.add( toResponseDataDTO( responseData ) );
        }
    ...
    @Override
    public ResponseData toResponseData(ResponseDataDTO responseDTO) {
        if ( responseDTO == null ) {
            return null;
        }
        ...
        responseData.setResponseDataID( responseDTO.getResponseDataID() );
        responseData.setData( responseDTO.getData() );
        responseData.setResponse( responseDTOToResponse( responseDTO.getResponse() ) );
