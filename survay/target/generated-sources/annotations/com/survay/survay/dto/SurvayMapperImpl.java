...
*/
@Component
public class SurvayMapperImpl implements SurvayMapper {

    @Override
    public SurvayDTO toSurvayDTO(Survay survay) {
        if ( survay == null ) {
            return null;
        }
    ...
    @Override
    public List<SurvayDTO> toSurvayDTOs(List<Survay> survay) {
        if ( survay == null ) {
            return null;
        }

        List<SurvayDTO> list = new ArrayList<SurvayDTO>( survay.size() );
        for ( Survay survay1 : survay ) {
            list.add( toSurvayDTO( survay1 ) );
        }
    ...
    @Override
    public Survay toSurvay(SurvayDTO survayDTO) {
        if ( survayDTO == null ) {
            return null;
        }
    ...
    protected SurvayDataDTO survayDataToSurvayDataDTO(SurvayData survayData) {
        ...
        survayDataDTO.setSurvay( toSurvayDTO( survayData.getSurvay() ) );
    ...
    protected ResponseDTO responseToResponseDTO(Response response) {
        ...
        responseDTO.setSurvay( toSurvayDTO( response.getSurvay() ) );
    ...
    protected SurvayURLDTO survayURLToSurvayURLDTO(SurvayURL survayURL) {
        ...
        survayURLDTO.setSurvay( toSurvayDTO( survayURL.getSurvay() ) );
    ...
    protected SurvayPasswordDTO survayPasswordToSurvayPasswordDTO(SurvayPassword survayPassword) {
        ...
        survayPasswordDTO.setSurvay( toSurvayDTO( survayPassword.getSurvay() ) );
    ...
    protected SurvayData survayDataDTOToSurvayData(SurvayDataDTO survayDataDTO) {
        ...
        survayData.setSurvay( toSurvay( survayDataDTO.getSurvay() ) );
    ...
    protected Response responseDTOToResponse(ResponseDTO responseDTO) {
        ...
        response.setSurvay( toSurvay( responseDTO.getSurvay() ) );
    ...
    protected SurvayURL survayURLDTOToSurvayURL(SurvayURLDTO survayURLDTO) {
        ...
        survayURL.setSurvay( toSurvay( survayURLDTO.getSurvay() ) );
    ...
    protected SurvayPassword survayPasswordDTOToSurvayPassword(SurvayPasswordDTO survayPasswordDTO) {
        ...
        survayPassword.setSurvay( toSurvay( survayPasswordDTO.getSurvay() ) );
